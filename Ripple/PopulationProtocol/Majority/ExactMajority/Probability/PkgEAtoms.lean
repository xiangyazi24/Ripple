...
Package E targets the `WorkInputsV51` fields
...
the exact `WorkInputsV51.hConc` field shape.
-/
...
/-- Package E adapter producing the exact `WorkInputsV51.hConc` field shape.

Field produced: `FinalAssemblyV51.WorkInputsV51.hConc`, namely the slot-5 sampled-class floor tail at
